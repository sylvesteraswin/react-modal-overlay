...
var factory = function factory(Overlay) {
  var Drawer = function Drawer(_ref) {
    ...
    var classes = (0, _classnames3.default)([theme.drawer, theme[type]], _defineProperty({}, theme.active, active), className);
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        {
          'data-react-zvui-framework': 'drawer',
          className: classes
        },
        _react2.default.createElement(
          'aside',
  ...
  Drawer.propTypes = {
    ...
    type: _react.PropTypes.oneOf(['left', 'right', 'top', 'bottom'])
  };
